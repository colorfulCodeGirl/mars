...
const Mars = () => {
  ...
  useEffect(() => {
    ...
    gsap.set([...stars, ...asteroids, ...auras, flash], {
    ...
    tl.to(current, { duration: 0.7, autoAlpha: 1 })
      ...
      .to(
        auras, { duration: 0.5, scale: 1.02, stagger: 0.2, repeat: -1, yoyo: true }, "animate"
      )
      .to(
        rover, { duration: 7, rotation: -360, ease: "linear", repeat: -1 }, "animate"
      )
      .to(
        rover, { duration: 0.2, scale: 1.02, y: "-=1", repeat: -1 }, "animate"
      )
      .fromTo(
